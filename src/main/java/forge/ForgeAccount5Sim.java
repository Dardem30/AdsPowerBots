...
public class ForgeAccount5Sim {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final FiveSimService fiveSimService = FiveSimService.getInstance();
...
//                    name = nameMatcher.group(2);
                ...
                nameMatcher.find();
                name = nameMatcher.group(2).split("<")[0].trim();
...
//            } catch (Exception e) {
            ...
            if (!alreadyRegistrated) {
                ...
                while (true) {
                    ...
                    smsActivationResponse = fiveSimService.purchaseVkActivation();
                    ...
                    try {
                        ...
                        try {
                            fiveSimService.cancelRequest(smsActivationResponse.getId());
                        } catch (Exception e) {

                        }
                    } catch (Exception e) {
                        System.out.println("Going to use phone number " + smsActivationResponse.getPhone());
//                        smsActivationResponse = fiveSimService.waitUntilPhoneIsReadyToReceiveCode(smsActivationResponse);
...
//                        }
                ...
                String verificationCode = fiveSimService.retrieveLastResultCodeOfThePurchase(smsActivationResponse.getId(), 1);
                ...
                if (verificationCode == null) {
                    ...
                    verificationCode = fiveSimService.retrieveLastResultCodeOfThePurchase(smsActivationResponse.getId(), 1);
                    if (verificationCode == null) {
                        fiveSimService.cancelRequest(smsActivationResponse.getId());
                ...
                try {
                    ...
                    fiveSimService.banRequest(smsActivationResponse.getId());
                    continue;
                } catch (Exception e) {
                    e.printStackTrace();
                }
                ...
                String verificationCodeForPassword = fiveSimService.retrieveLastResultCodeOfThePurchase(smsActivationResponse.getId(), 2);
                if (verificationCodeForPassword == null) {
                    ...
                    verificationCodeForPassword = fiveSimService.retrieveLastResultCodeOfThePurchase(smsActivationResponse.getId(), 2);
                    if (verificationCodeForPassword == null) {
                        fiveSimService.finishRequest(smsActivationResponse.getId());
...
//                }
    ...
    private static WebElement waitUntilElementWhichContainsTextWillBePresent(final ChromeDriver driver, final String tag, final String text) {
